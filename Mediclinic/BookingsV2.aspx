        ...
        function live_search(str) {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    document.getElementById("div_livesearch").style.zIndex = "2001";
                }
            }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <div class="clearfix">
            ...
            <div class="main_content" style="padding:10px 5px 20px;">
                ...
                <table class="block_center" id="tbl_booking_sheet" oncontextmenu="return false;" style="z-index:-200;">
                    <tr>
                        <td> 
                             <asp:Panel ID="header_panel" runat="server" ScrollBars="Auto" Width="1497" style="position: relative; z-index:10" onscroll="Javascript:elementOnScroll(this);elementOnScrollLeft(this);">
                                 <%--Create an empty div and table and fill with cloned time column --%>
                                 <table id="targetH" border="1"  runat="server" class="booking-table-grid-header" style="z-index:10"></table>
                                 <table border="1" id="header_table" runat="server" class="booking-table-grid-header" style="width:1480px;max-width:1480px;z-index:10;"></table>
                            </asp:Panel>
                              <asp:Panel ID="main_panel" runat="server" ScrollBars="Auto" Height="550" Width="1497" style="min-height:150px; position: relative; z-index:10;" onscroll="JavaScript:elementOnScroll(this);elementOnScrollLeft(this);" >
                                  <%--Create an table and fill with cloned header --%>
                                  <table id="targetT" border="1"  runat="server" class="booking-table-grid-body" style="border-color: #800080; z-index:10"></table>
                                  <table border="1" id="main_table" runat="server" class="booking-table-grid-body" style="width:1480px;max-width:1480px; z-index:10" ></table>
